...
void myAbjInit()
{
    ...
    myAbj.autoRepeatPrevent0.resetTimer = 1; //A
    myAbj.autoRepeatPrevent1.resetTimer = 1; //B
    myAbj.autoRepeatPrevent2.resetTimer = 1; //X
    myAbj.autoRepeatPrevent3.resetTimer = 1; //Y
    myAbj.autoRepeatPrevent4.resetTimer = 1; //LB
    myAbj.autoRepeatPrevent5.resetTimer = 1; //RB
    myAbj.autoRepeatPrevent6.resetTimer = 1; //back
    myAbj.autoRepeatPrevent7.resetTimer = 1; //start
    myAbj.autoRepeatPrevent8.resetTimer = 1; //xbox

//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent0);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent1);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent2);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent3);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent4);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent5);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent6);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent7);
//    myAbj.autoRepeatVec.push_back(myAbj.autoRepeatPrevent8);

//    myAbj.autoRepeatVec =
//    {
//        myAbj.autoRepeatPrevent0, myAbj.autoRepeatPrevent1, myAbj.autoRepeatPrevent2, myAbj.autoRepeatPrevent3, myAbj.autoRepeatPrevent4, myAbj.autoRepeatPrevent5, myAbj.autoRepeatPrevent6, myAbj.autoRepeatPrevent7, myAbj.autoRepeatPrevent8
//    };
}
